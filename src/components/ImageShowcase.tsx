...
export default function ImageShowcase() {
  return (
    <>
      ...
      <section
        id="work"
        className="relative w-full overflow-hidden h-[50vh] sm:h-[60vh] lg:h-auto"
      ...
      >
        <video
          ...
          playsInline
          preload="auto"
          className="h-full object-cover object-left lg:h-auto lg:object-contain lg:object-center"
          style={{
            display: 'block',
            width: '100%',
          }}
