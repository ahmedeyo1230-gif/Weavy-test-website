    ...
    <>
      ...
      >
        <video
          ...
          playsInline
          preload="auto"
          className="object-cover object-top h-[73vw] sm:h-[73vw] lg:h-auto lg:object-contain lg:object-center"
          style={{
            display: 'block',
            width: '100%',
          }}
      ...
      >
        <div className="relative max-w-[109rem] mx-auto px-4 sm:px-8">
          <video
            autoPlay
            muted
            loop
