    ...
    >
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.05fr] gap-12 xl:gap-16 items-center mb-14 lg:mb-20">
          ...
          >
            <div
              className="relative w-full lg:[transform:scale(1.48)_translateX(10%)]"
              style={{
          ...
          {SERVICE_MODULES.map((svc, i) => (
            ...
            >
              <BorderRotate
                ...
                borderRadius={12}
                animationSpeed={4}
                className="group relative px-5 py-5 overflow-hidden cursor-pointer h-full"
              >
                {/* Top accent line */}
                <div
                  className="absolute top-0 left-0 right-0 h-px opacity-0 group-hover:opacity-100"
                  style={{
                    background: 'linear-gradient(to right, transparent, hsl(199 89% 60% / 0.5), transparent)',
                    transition: 'opacity 280ms',
                  }}
                />
                <div className="text-xs font-serif italic text-muted/35 mb-3 select-none">{svc.num}</div>
