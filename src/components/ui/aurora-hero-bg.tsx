...
/**
 * Standalone aurora background layer — use this when you only need
 * the animated gradient behind existing content (no hero markup).
 */
    ...
    <div className={cn("absolute inset-0 overflow-hidden pointer-events-none", className)} aria-hidden="true">
      <motion.div
        ...
        style={{
          background: `repeating-linear-gradient(100deg,
            #8b5cf6 10%, #3b82f6 15%, #ec4899 20%, #8b5cf6 25%, #3b82f6 30%)`,
          backgroundSize: "300% 100%",
          filter: "blur(80px)",
          opacity: 0.18,
        }}
      ...
      <motion.div
        ...
        style={{
          background: `
            repeating-linear-gradient(100deg,
              rgba(139,92,246,0.06) 0%, rgba(139,92,246,0.06) 7%,
              transparent 10%, transparent 12%,
              rgba(139,92,246,0.06) 16%),
            repeating-linear-gradient(100deg,
              #8b5cf6 10%, #3b82f6 15%, #ec4899 20%, #8b5cf6 25%, #3b82f6 30%)`,
          backgroundSize: "200%, 100%",
          backgroundPosition: "50% 50%, 50% 50%",
      ...
      />
      {/* Edge vignette to keep it contained */}
      <div
        className="absolute inset-0"
        style={{
          background: "radial-gradient(ellipse at center, transparent 30%, #010709 90%)",
        }}
      />
    </div>
  );
