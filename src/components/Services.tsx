    ...
    <>
      ...
      >
        ...
        <div aria-hidden="true" style={{
          ...
          background: 'radial-gradient(ellipse 90% 70% at 60% 55%, rgba(7,20,26,0.92) 0%, transparent 70%)',
        }}/>
        ...
        <div aria-hidden="true" style={{
          position: 'absolute', inset: 0, pointerEvents: 'none', zIndex: 0,
          background: [
            'radial-gradient(ellipse 60% 55% at 66% 58%, rgba(232,201,122,0.106) 0%, transparent 68%)',
            'radial-gradient(ellipse 40% 35% at 66% 58%, rgba(191,164,90,0.079) 0%, transparent 55%)',
          ].join(', '),
          filter: 'blur(18px)',
        }}/>
        ...
        <div aria-hidden="true" style={{
          ...
          background: [
            'linear-gradient(to right,  rgba(1,7,9,0.73) 0%, transparent 22%, transparent 78%, rgba(1,7,9,0.73) 100%)',
            'linear-gradient(to bottom, rgba(1,7,9,0.59) 0%, transparent 18%, transparent 84%, rgba(1,7,9,0.79) 100%)',
          ].join(', '),
        }}/>
