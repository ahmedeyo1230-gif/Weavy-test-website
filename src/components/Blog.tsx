      ...
      <div className="relative flex flex-col items-center" style={{ zIndex: 10 }}>
        ...
        >
          <div className="flex items-center gap-2.5">
            ...
            <span className="font-sans font-light footer-availability-text" style={{ fontSize: '0.75rem', letterSpacing: '0.05em', color: 'hsl(0 0% 48%)' }}>
              Available for projects
            </span>
          </div>
          <p className="font-sans font-light text-center footer-copyright-text" style={{ fontSize: '0.7rem', letterSpacing: '0.05em', color: 'hsl(0 0% 28%)' }}>
